...
public class ViewDragHelper {
    ...
    private void handleAction(MotionEvent ev, final int action) {
        final int actionIndex = MotionEventCompat.getActionIndex(ev);
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                break;
            case MotionEventCompat.ACTION_POINTER_DOWN:
                onActionPointerDown(ev, actionIndex);
                break;
            case MotionEvent.ACTION_MOVE:
                onActionMove(ev);
                break;
            case MotionEventCompat.ACTION_POINTER_UP:
                onActionPointerUp(ev, actionIndex);
                break;
            case MotionEvent.ACTION_UP:
                onActionUp();
                break;
    ...
    private void onActionPointerDown(MotionEvent ev, final int actionIndex) {
        final int pointerId = MotionEventCompat.getPointerId(ev, actionIndex);
        final float x = MotionEventCompat.getX(ev, actionIndex);
        final float y = MotionEventCompat.getY(ev, actionIndex);
    ...
    private void onActionPointerUp(MotionEvent ev, final int actionIndex) {
        final int pointerId = MotionEventCompat.getPointerId(ev, actionIndex);
