...
public class WearBrowserService extends MediaBrowserService {
    ...
    private void addMediaItem(List<MediaBrowser.MediaItem> mMediaRoot, int type, int title, int subtitle) {
        mMediaRoot.add(new MediaBrowser.MediaItem(
                new MediaDescription.Builder()
                        .setMediaId(Integer.toString(type))
    ...
    private void addMediaRoots(List<MediaBrowser.MediaItem> mMediaRoot) {
        addMediaItem(mMediaRoot, TYPE_ARTIST, R.string.artists, R.string.artists);
        addMediaItem(mMediaRoot, TYPE_ALBUM, R.string.albums, R.string.albums);
        addMediaItem(mMediaRoot, TYPE_SONG, R.string.songs, R.string.songs);
        addMediaItem(mMediaRoot, TYPE_PLAYLIST, R.string.playlists, R.string.playlists);
    }
